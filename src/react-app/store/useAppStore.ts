...
<h3>1. איסוף מידע</h3>
<p>1.1 <strong>מידע אישי:</strong> בעת ההרשמה, אנו מקבלים את שמך וכתובת האימייל שלך.<br>1.2 <strong>מידע שימוש:</strong> אנו אוספים מידע סטטיסטי על השימוש במערכת לצורך שיפור השירות.<br>1.3 <strong>הקלטות:</strong> הקלטות אודיו נשמרות בשרת המערכת המאובטח, והמידע עליהן נשמר במסד הנתונים המקומי.</p>
<h3>2. שימוש במידע</h3>
<p>המידע הנאסף משמש ל: (א) אספקת השירותים והתכונות השונות, (ב) שיפור חוויית המשתמש, (ג) תמיכה טכנית, (ד) עמידה בדרישות חוק.</p>
<h3>3. אבטחת מידע</h3>
<p>3.1 אנו נוקטים באמצעי אבטחה מתקדמים להגנת המידע, לרבות הצפנת תעבורה ב-TLS.<br>3.2 מפתחות ה-API שלך נשמרים בדפדפן שלך. הם עוברים דרך שרת המערכת לצורך עיבוד הבקשות לספקי ה-AI, אך אינם נשמרים בשרת.<br>3.3 הגישה למערכת מנוהלת באמצעות מנגנון הזדהות מאובטח עם חשבון אישי.</p>
...
<p><em>עודכן לאחרונה: יוני 2026</em></p>`
};
