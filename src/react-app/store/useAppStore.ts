...
<h3>1. איסוף מידע</h3>
<p>1.1 <strong>מידע אישי:</strong> בעת ההרשמה באמצעות Google OAuth, אנו מקבלים את שמך וכתובת האימייל שלך.<br>1.2 <strong>מידע שימוש:</strong> אנו אוספים מידע סטטיסטי על השימוש במערכת לצורך שיפור השירות.<br>1.3 <strong>הקלטות:</strong> הקלטות אודיו נשמרות בשרתי Cloudflare R2 והקשר ביניהן לבין חשבונך נשמר במסד הנתונים.</p>
<h3>2. שימוש במידע</h3>
<p>המידע הנאסף משמש ל: (א) אספקת השירותים והתכונות השונות, (ב) שיפור וחוויית המשתמש, (ג) תמיכה טכנית, (ד) עמידה בדרישות חוק.</p>
<h3>3. אבטחת מידע</h3>
<p>3.1 אנו נוקטים באמצעי אבטחה מתקדמים להגנת המידע, לרבות הצפנת תעבורה ב-TLS.<br>3.2 מפתחות ה-API שלך נשמרים אך ורק בדפדפן שלך ואינם נגישים לנו.<br>3.3 הסיסמאות מנוהלות באמצעות Google OAuth ואינן נשמרות במערכת.</p>
<h3>4. שיתוף מידע עם צדדים שלישיים</h3>
<p>4.1 אנו לא מוכרים או משכירים מידע אישי לצדדים שלישיים.<br>4.2 מידע עשוי להיות משותף עם: (א) Cloudflare – אחסון ותשתית, (ב) Google OAuth – הזדהות, (ג) ספקי AI (Gemini, Groq, OpenAI) – עיבוד טקסט לפי בחירתך.</p>
<h3>5. זכויותיך</h3>
